...
class Config:
    ...
    train: FBTrainConfig = dataclasses.field(default_factory=FBTrainConfig)
...
def select_exploratory_z(agent: FBAgent, obs: np.ndarray, config: Config) -> torch.Tensor:
        with torch.no_grad():
...
if __name__ == "__main__":
    ...
    agent = FBAgent(**dataclasses.asdict(config))
